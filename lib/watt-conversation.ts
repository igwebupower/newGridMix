...
- Call at least one tool before answering any question about grid data, prices, solar, frequency, carbon intensity, or historical UK electricity trends.
...
export async function runWattConversation(question: string, apiKey: string): Promise<string> {
